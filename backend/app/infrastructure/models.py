...
class User(Base):
    ...
    hedera_public_key: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ...
    payment_token_preference: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    created_at: Mapped[str] = mapped_column(String, nullable=False)

    homes: Mapped[list["Home"]] = relationship("Home", back_populates="owner", cascade="all, delete-orphan")
    supplier_profile: Mapped[Optional["SupplierProfile"]] = relationship("SupplierProfile", back_populates="user", uselist=False, cascade="all, delete-orphan")
...
class Room(Base):
    ...
    name: Mapped[str] = mapped_column(String, nullable=False)
    sq_meters: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
...
class Job(Base):
    ...
    supplier_user_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("users.id"), nullable=True)
    accepted_bid_id: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    available_times: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    status: Mapped[str] = mapped_column(String, nullable=False)
    escrow_account_id: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ...
    supplier: Mapped[Optional["User"]] = relationship("User", foreign_keys=[supplier_user_id])
...
class AIValidation(Base):
    ...
    requested_corrections: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
...
class EscrowTransaction(Base):
    ...
    status: Mapped[str] = mapped_column(String, nullable=False)
    hedera_tx_id: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    created_at: Mapped[str] = mapped_column(String, nullable=False)
...
class SupplierProfile(Base):
    ...
    portfolio_items: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    average_rate: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class ProofUpload(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    job_id: Mapped[int] = mapped_column(Integer, ForeignKey("jobs.id", ondelete="CASCADE"), nullable=False)
    photo_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("photos.id", ondelete="SET NULL"), nullable=True)
    uploaded_by_user_id: Mapped[int] = mapped_column(Integer, ForeignKey("users.id"), nullable=False)
    file_type: Mapped[str] = mapped_column(String, nullable=False)
    storage_url: Mapped[str] = mapped_column(String, nullable=False)
    cid: Mapped[str] = mapped_column(String, nullable=False)
    room_or_area_label: Mapped[Optional[str]] = mapped_column(String, nullable=True)
